...
| 数据源 | 格式 | 当前最大（2026-09-22） |
|---|---|---|
| 主新闻流 | `2026-NNN` | **2026-223** |
| 执法动态 | `eN` | **e87** |
| 各国监管局 | `dpa-{eu\|ie\|uk\|tr\|fr\|de\|ch}-NNN` | dpa-eu-029 / dpa-ie-012 / dpa-de-003 / dpa-ch-004 / dpa-fr-002 / dpa-uk-004 / dpa-tr-003 |
| 法规库 | `N` | **15** |
| 法规库行业动态 | `iN` | **i6** |
| 首页卡片 | `N` | 1–6 |
