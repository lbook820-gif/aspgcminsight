...
const legislationItems: LegislationItem[] = [
  ...
  },
  {
    ...
    status: '已生效（修订中）',
    summary:
      '2024年8月正式生效，2026年5月欧洲议会与成员国达成修订协议：禁止AI生成深度伪造色情内容（2026年12月2日生效）；高风险AI系统合规期限推迟——独立系统延至2027年12月2日、产品内嵌式系统延至2028年8月2日；机械设备排除在AI法案管辖范围之外。内容水印标记义务自2026年12月2日起实施。对移动应用中使用的AI功能设定分级监管要求。',
  ...
  },
  {
    ...
    status: '已生效',
    summary:
      '2024年2月起全面适用，要求大型在线平台建立内容审核机制、广告透明度系统和风险管理体系。2026年5月28日，欧盟依据DSA对Temu处以2亿欧元最高罚单，认定其风险评估严重不足，未能有效遏制非法商品销售。此前欧盟已对X（原Twitter）处以1.2亿欧元罚款。目前欧盟正评估将ChatGPT（1.204亿月活）纳入VLOP监管范围。VLOP需履行系统性风险评估、年度外部审计、广告透明度、研究人员数据访问等严格义务。违规最高可面临全球年营收6%罚款。移动应用作为内容传播渠道，需建立投诉处理机制和非法内容报告系统。',
