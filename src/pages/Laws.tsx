...
const legislationItems: LegislationItem[] = [
  {
    ...
    status: '已生效',
    summary:
      '2024年3月起全面生效，针对苹果、谷歌、Meta等守门人平台设定开放义务。2026年5月22日，欧盟委员会发布DMA第三年度报告，回顾执法成果：首轮对苹果（5亿欧元）和Meta（2亿欧元）开出罚款；2026年5月拟对谷歌开出近10亿欧元DMA最大罚单，认定搜索自我优待违规。DMA执法范围正向云计算（AWS/Azure守门人认定调查）、AI助手（Android系统级AI能力开放）扩展。违反者最高可处全球营收10%罚款。',
