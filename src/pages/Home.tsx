              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-[#525252] leading-relaxed space-y-2">
                    ...
                    <p>
                      <strong>未成年人保护升级：</strong>欧盟委员会于4月29日初步认定Meta违反DSA，未能阻止13岁以下儿童使用Instagram和Facebook，面临高达121亿美元罚款。同日冯德莱恩宣布《数字公平法案》将推动社交媒体最低准入年龄立法。英国ICO联合Ofcom要求平台4月底前提交年龄验证方案。
                    </p>
                    <p>
