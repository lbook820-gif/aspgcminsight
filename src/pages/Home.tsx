...
const todayNews: NewsItem[] = [
  ...
  },
  {
    ...
    date: '2026-04-22',
    heat: 9,
    title: '特朗普政府怒斥欧盟罚款是"对美国科技巨头的关税"，两年罚单超70亿美元',
    summary:
      '据腾讯新闻报道，欧盟在过去两年内对美国科技巨头开出的罚单总额已超过70亿美元。特朗普政府官员怒斥这些罚款实质上是"对美国科技巨头的关税"。欧盟委员会坚持认为其监管框架目标在于保护消费者而非打压创新，罚款是"最后手段"，仅在寻求友好解决方案失败后才会诉诸。',
    overallImpact:
