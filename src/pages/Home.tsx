              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-[#525252] leading-relaxed space-y-2">
                    ...
                    <p>
                      <strong>TikTok广告透明度被认定违规：</strong>欧盟委员会于5月15日发布初步认定，指出TikTok广告库设置和信息披露违反DSA，未能提供广告内容、目标受众和出资方等关键信息，或面临全球年营收6%罚款。
                    </p>
                    <p>
                    ...
                    <p className="text-[#737373] italic mt-3">
                      💡 出海企业需重点关注：AI系统风险评估、年龄验证技术部署、广告透明度合规、英国DMCC云服务监管动态。
                    </p>
                  </div>
                </div>
              </div>
